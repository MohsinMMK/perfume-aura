...
| COM-FND-004 | CAT-002, CAT-003: missing business facts remain visibly unresolved. | `pnpm commerce:verify` | Immutable source rows remain `needs_review`; all launch products remain overall `needs_owner_input`; launch variants remain `needs_price_sku_stock`; staged name or mapping approval cannot make a row publishable while price, content, media, legal, or stock gates remain incomplete. | Pass 2026-07-30: all 103 products and 412 variants remain non-publishable/non-importable after staged naming approvals. | Verified |
...
| COM-FND-008 | COM-ADR-007–022: reviewed decision statuses and owner wording remain stable. | `pnpm commerce:verify` plus human prose review | Verifier enforces COM-ADR-008 and 015 as Superseded, COM-ADR-011 as Pending, COM-ADR-022 bottle/packaging disablement as Accepted, and current decisions through COM-ADR-022 as deliberately reviewed. Exact checks protect Signature-name/in-house classification, tester, mapping, unresolved-reference, bulk-approval, reference-title, and bottle-label policy wording. | Pass 2026-07-30: 22 sequential decisions, statuses, and current owner statements enforced. | Verified |
...
| COM-FND-010 | CAT-003, CAT-004, COM-ADR-014: variant workbook uses one row per product × size. | `pnpm commerce:verify` | Exactly 412 ordered rows = 103 products × 10/30/50/100 ml; INR; owner-approved 10 ml tester type and 30/50/100 ml bottle type; availability intent recorded; SKU, price, cost, numeric stock, and reorder values blank and blocked. | Pass 2026-07-30: 412 selected, non-importable variant rows validated. | Verified |
