...
| COM-FND-008 | COM-ADR-007–026: reviewed decision statuses and owner wording remain stable. | `pnpm commerce:verify` plus human prose review | Verifier enforces superseded historical decisions, the accepted storefront/catalog/India-provider/design decisions through COM-ADR-026, and the retained owner statements that govern naming, mapping, legal review, and packaging. | Pending re-verification after the accepted 2026-08-02 decisions. | In progress |
