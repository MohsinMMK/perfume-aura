...
These optimizations are already implemented on the active staff branch. Do not
repeat broad optimization without a measured regression or representative new
release data.
