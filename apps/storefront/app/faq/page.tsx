...
const questions = [
  ["What is Perfume Aura?", "Perfume Aura is an India-focused fragrance house. The public website currently introduces the brand and helps visitors understand how to choose a scent while the first complete collection is being prepared."],
