...
export default function RecoverPage() { const enabled = process.env.STOREFRONT_CUSTOMER_AUTH_ENABLED === "true"; return <><p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#79633e]">Customer account</p><h1 className="mt-3 font-[var(--font-playfair)] text-6xl sm:text-8xl">Recover access.</h1><AccountForm mode="recover" enabled={enabled} providers={customerAuthProviderReadiness()} /></>; }
