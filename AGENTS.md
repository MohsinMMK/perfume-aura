...
- `docs/OBSERVABILITY.md` — telemetry, privacy, activation, and verification.
...
- Use official shadcn CLI/App Router/Better Auth/Drizzle/Neon/Hostinger/pnpm
  paths and official PostHog/Sentry SDK integration. Shared UI belongs in
  `packages/ui`; preset `b23PPibQOI` must resolve.
